# Generated by Django 3.2.15 on 2022-11-12 02:16
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lang', models.CharField(help_text='Enter a language of the book (English, russian, etc...)', max_length=100, null=True, verbose_name='Язык')),
                ('summary', models.TextField(help_text='Enter a brief description of the book', max_length=1000, verbose_name='Описание')),
                ...
                ('favourites', models.ManyToManyField(blank=True, db_constraint=False, to=settings.AUTH_USER_MODEL, verbose_name='Избранное')),
            ],
            options={
                'verbose_name': 'Книга',
