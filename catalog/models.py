...
class Book(models.Model):
    ...
    lang = models.CharField(max_length=100,
                            help_text="Enter a language of the book (English, russian, etc...)",
    ...
    favourites = models.ManyToManyField(User, blank=True, verbose_name='Избранное', db_constraint=False)
